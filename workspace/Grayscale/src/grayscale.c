	...
	while(1){
		...
		//for(j = 0; j<480 ; j++){
			...
			for(i=0; i<(320*480) ; i++){
				...
				//s_pixel = pixels >> 16;
				f_grayscale = ( /*Red*/ (f_pixel >> 11) + /*Green*/ ( (f_pixel >> 5) & 0x0000003F) + /*Blue*/ ( f_pixel & 0x0000001F) ) / 3;
				s_grayscale = ( /*Red*/ (pixels >> 27) + /*Green*/ ( (pixels >> 21) & 0x0000003F) + /*Blue*/ (( pixels >> 16) & 0x0000001F) ) / 3;
				grayscale = (s_grayscale << 27) | (s_grayscale << 21) | (s_grayscale << 16) | (f_grayscale << 11) | (f_grayscale << 5) | (f_grayscale);
				...
				f_pixel = pixels & 0x0000FFFF;
				//s_pixel = pixels >> 16;
				f_grayscale = /*Red*/ (f_pixel >> 11) * 0.21 + /*Green*/ ( (f_pixel >> 5) & 0x0000003F) * 0.71 + /*Blue*/ ( f_pixel & 0x0000001F) * 0.07;
				s_grayscale = /*Red*/ (pixels >> 27) * 0.21 + /*Green*/ ( (pixels >> 21) & 0x0000003F) * 0.71 + /*Blue*/ (( pixels >> 16) & 0x0000001F) * 0.07;
				grayscale = (s_grayscale << 27) | (s_grayscale << 21) | (s_grayscale << 16) | (f_grayscale << 11) | (f_grayscale << 5) | (f_grayscale);
				ddr_addr2[i] = grayscale;
#endif
